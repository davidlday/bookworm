...
public class ReadabilityScoresTest {
  ...
  public void testReadabilityScores() {
    ...
    assertEquals("Automated Readability Index: ", expectedScores.getAutomatedReadabilityIndex(), scores.getAutomatedReadabilityIndex());
    assertEquals("Coleman Liau Index: ", expectedScores.getColemanLiauIndex(), scores.getColemanLiauIndex());
    assertEquals("Flesch Kincaid Grade Level: ", expectedScores.getFleschKincaidGradeLevel(), scores.getFleschKincaidGradeLevel());
    assertEquals("Flesch Reading Ease: ", expectedScores.getFleschReadingEase(), scores.getFleschReadingEase());
    assertEquals("Gunning Fox Index: ", expectedScores.getGunningFogIndex(), scores.getGunningFogIndex());
